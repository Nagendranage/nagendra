...
public class BlogSpot 
{
	public static void main(String[] args) throws InterruptedException 
	{
		...
		driver.findElement(By.xpath("//*[@id=\"HTML42\"]/div[1]/form/input[1]")).sendKeys("Nag"); 
		
		//Enter the password of simple login page
		driver.findElement(By.xpath("//*[@id=\"HTML42\"]/div[1]/form/input[2]")).sendKeys("Nag@123");  
		...
		//HTML Form Username
		driver.findElement(By.xpath("//*[@id=\"HTML31\"]/div[1]/form/input[1]")).sendKeys("Nag"); 
		//HTML Form Password
		driver.findElement(By.xpath("//*[@id=\"HTML31\"]/div[1]/form/input[2]")).sendKeys("Nag@123");  
		//Clicking on login
